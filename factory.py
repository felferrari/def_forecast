...
def build(experiments, run_name):
    ...
    if 'parent_experiment' in run_description.keys():
        run_description = run_description | experiments[run_description['parent_experiment']] 
    ...
    return model, data_module, criterion, optimizer, optimizer_params, train_params, predict_params