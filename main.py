...
def train(run_name):
    ...
    with mlflow.start_run(run_name=run_name, log_system_metrics = True):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            model, data_module, criterion, optimizer, optimizer_params, train_params, _ = build(experiments, run_name)
...
def predict(run_name):
    _, data_module, _, _, _, _, predict_params = build(experiments, run_name)
