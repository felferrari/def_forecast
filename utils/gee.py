...
def export_sar(img, roi, name, scale = 10, crs = None):
    task_config = {
        'scale': scale, 
        'crs': crs,
        'folder':'GEE_imgs_sar',
...
def export_sar_VV(img, roi, name, scale = 10, crs = None):
    task_config = {
        'scale': scale, 
        'crs': crs,
        'folder':'GEE_imgs_sar',
...
def export_sar_HH(img, roi, name, scale = 10, crs = None):
    task_config = {
        'scale': scale, 
        'crs': crs,
        'folder':'GEE_imgs_sar',
...
def export_nv(img, roi, name, crs: None):
    task_config = {
        'scale': 1000, 
        'crs': crs,
        'folder':'GEE_clua',
